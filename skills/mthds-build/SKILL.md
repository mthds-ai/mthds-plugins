...
**Show bundle overview** — see [Manual Build Phases](references/manual-build-phases.md#phase-2-bundle-overview) for the overview description.
...
**Show detailed flow** — see [Manual Build Phases](references/manual-build-phases.md#phase-5-controller-flow-patterns) for all controller flow patterns.
...
- [Manual Build Phases](references/manual-build-phases.md) — read for detailed flow descriptions and CLI examples per phase
