...
[ -n "$_best_f" ] && exec "$_best_f" "0.6.2" --codex
...
If the user prefers an interactive setup, tell them to run `pipelex init inference` in their own terminal (not through Codex).
