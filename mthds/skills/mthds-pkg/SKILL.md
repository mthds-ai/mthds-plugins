...
```bash
~/.claude/plugins/marketplaces/mthds-plugins/bin/mthds-env-check "0.5.0" 2>/dev/null || ../mthds-plugins/bin/mthds-env-check "0.5.0" 2>/dev/null || echo "MTHDS_ENV_CHECK_MISSING"
```
